const tr = {
  fa: {
    ...
    'hero.title1': 'هر شی را با',
    'hero.title2': 'دقت هوش مصنوعی',
    'hero.title3': ' بشمار',
    'hero.subtitle': 'شی مورد نظر را انتخاب کنید، تصویر را بارگذاری کنید، و مدل هوش مصنوعی تخصصی بقیه کار را انجام می‌دهد — شمارش دقیق با حذف هوشمند موارد تکراری.',
    'hero.cta1': 'انتخاب شی',
    'hero.cta2': 'شروع کنید',
    'features.label': 'امکانات',
    'features.title': 'شمارش هوشمند برای هر شی',
    'feat1.title': 'تشخیص چندشی',
    'feat1.desc': 'هر شی را با مدل اختصاصی آن تشخیص دهید — از اشیای عمومی تا تخصصی.',
    'feat2.title': 'مدل اختصاصی',
    'feat2.desc': 'هر شی مدل YOLO بهینه‌شده خود را دارد برای بهترین دقت تشخیص.',
    'feat3.title': 'حذف تکراری',
    'feat3.desc': 'تشخیص هوشمند اشیای هم‌پوشان با IoU — شمارش دقیق بدون دوبرابر شدن.',
    'feat4.title': 'مقایسه بصری',
    'feat4.desc': 'مقایسه تصویر اصلی و تحلیل‌شده با اسلایدر کشویی برای بررسی دقیق.',
    'feat5.title': 'تنظیم آستانه',
  ...
  en: {
    ...
    'hero.title1': 'Count any object with ',
    'hero.title2': 'AI Precision',
    'hero.title3': '',
    'hero.subtitle': 'Select your target object, upload an image, and let the specialized AI model handle the rest — accurate counting with intelligent deduplication.',
    'hero.cta1': 'Select Object',
    'hero.cta2': 'Start Now',
    'features.label': 'Features',
    'features.title': 'Smart counting for any object',
    'feat1.title': 'Multi-object',
    'feat1.desc': 'Detect any object with its dedicated model — from general to specialized items.',
    'feat2.title': 'Dedicated Models',
    'feat2.desc': 'Each object has its own optimized YOLO model for best-in-class detection accuracy.',
    'feat3.title': 'Dedup Removal',
    'feat3.desc': 'Intelligent overlap detection with IoU — accurate counts without double counting.',
    'feat4.title': 'Visual Compare',
    'feat4.desc': 'Compare original and analyzed images side-by-side with a draggable slider.',
    'feat5.title': 'Threshold Tuning',
